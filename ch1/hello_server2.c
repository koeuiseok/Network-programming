...
int main(int argc, char* argv[])
{
	...
	char message[][64] = {"Hello World!", "hi my name is ko", "Nice to meet you", "gegehe"};
	...
	for(int cnt_i =0; cnt_i<sizeof(message)/sizeof(message[0]); cnt_i ++){
		write(clnt_sock, message[cnt_i], sizeof(message[cnt_i]));
